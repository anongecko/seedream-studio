# Seedream 4.5 (Upgrade from original app use of 4.0) Documentation
...
data.error.**code**
The error code for a failed image generation. See [Error Codes](https://docs.byteplus.com/en/docs/82379/1299023).
